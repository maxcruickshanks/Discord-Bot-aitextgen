...
class aitextgen:
    ...
    def generate(
        ...
        **kwargs,
        ...
        if prompt:
            if list(prompt_tensors["input_ids"].shape)[1] >= model_max_length(self.model.config):
                prompt_tensors["input_ids"] = prompt_tensors["input_ids"][:, -model_max_length(self.model.config)//2-1:]
